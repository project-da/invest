...
<body>
  ...
  <div id="login-page">
    <div class="container">
      <form class="form-login" action="<?php echo e(route('register-user')); ?>" method="post">
        ...
        <div class="login-wrap">
          <input type="text" class="form-control" placeholder="User Name"  name="name" value="<?php echo e(old('name')); ?>" >
...
unset($__errorArgs, $__bag); ?></span>
          <br>
          <input type="text" class="form-control" placeholder="Mobile Number" name="mobileNo" value="<?php echo e(old('mobileNo')); ?>" >
...
<?php /**PATH C:\xampp\htdocs\invest\resources\views/login/adminregister.blade.php ENDPATH**/ ?>